...
Puede abrir la raíz de este repositorio directamente como vault de Obsidian.
En el superproyecto `Tesis` se monta en `docs/investigacion`. El índice de la
bitácora está en `Notes/bitacora/INDICE.md` y el estado del proceso documental
en `Notes/bitacora/MEMORIA_PROGRESO.md`.

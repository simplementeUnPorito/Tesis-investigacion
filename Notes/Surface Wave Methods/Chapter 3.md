...
En el análisis de ondas superficiales, el tiempo de arribo de una onda a cada geófono produce una diferencia de fase en el [[Cross-Power Spectrum|espectro cruzado]] entre trazas. Esta diferencia de fase es la base de la estimación de velocidad de fase.
...
Una onda plana armónica unitaria con número de onda circular $k_0$ y [[Angular Frequency|frecuencia angular]] $\omega_0$ se escribe (Foti Ec. 3.19):
...
Un **[[Dirac Delta|impulso de Dirac]]** perfectamente localizado en $(k_0, \omega_0)$ del plano f-k (Figura 3.15, p. 143). En muestreo ideal e infinito, la onda plana aparece como un punto exacto: no hay ambigüedad en su velocidad de fase.
...
Sin embargo, las **limitaciones del array lineal para datos pasivos son severas**: solo puede identificar la proyección del número de onda a lo largo del eje del array. Si el campo no es isótropo (lo que ocurre frecuentemente en zonas urbanas con fuentes direccionales dominantes), los resultados pueden ser erróneos. El método [[ReMi Method|ReMi]] tiene ventajas logísticas importantes pero debe aplicarse con cautela y verificar la hipótesis de isotropía.

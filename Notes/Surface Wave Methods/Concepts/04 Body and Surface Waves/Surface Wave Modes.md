...
La [[Dispersion Curve|curva de dispersión]] modal de cada modo se traza en el plano frecuencia–[[Phase Velocity|velocidad de fase]]. En un perfil normalmente dispersivo:

- El modo fundamental tiene [[Phase Velocity|velocidad de fase]] creciente a alta frecuencia (capas más rígidas superficiales) y decreciente a baja frecuencia.
...
Lo que los métodos experimentales (f-k, [[MASW Method|MASW]], [[SASW Method|SASW]]) miden no es la curva de un modo individual sino la **[[Phase Velocity|velocidad de fase aparente]]** resultante de la superposición de todos los modos activos:
...
## Implicaciones para [[MASW Method|MASW]] / adquisición
...
| Xia et al. (2003), *J. Appl. Geophys.* 52:45–57 | Paper 025 — inversión [[MASW Method|MASW]] multimodal; mejora resolución profunda; 448 citas |

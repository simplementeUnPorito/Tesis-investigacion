...
description: Principio que extiende las soluciones elásticas a medios viscoelásticos reemplazando los módulos reales por módulos complejos — base teórica del cálculo de curvas de dispersión en medios con amortiguamiento
type: reference
---
...
donde $\alpha_R$ es el coeficiente de atenuación espacial (Np/m). La relación con $D_s$:
...
El Principio de Correspondencia permite calcular la curva de atenuación de Rayleigh $\alpha_R(f)$ de un perfil viscoelástico estratificado:
...
|--------|-----------------|
| Foti et al. (2018), *Surface Wave Methods* | §2.2 — Principio de Correspondencia en MASW |

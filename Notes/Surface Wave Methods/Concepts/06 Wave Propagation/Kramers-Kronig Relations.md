...
description: Relaciones integrales que vinculan la parte real e imaginaria de cualquier función de respuesta causal — en viscoelasticidad conectan la velocidad de fase con el coeficiente de atenuación
type: reference
---
...
En un medio viscoelástico estratificado, la velocidad de fase de la onda de Rayleigh varía con la frecuencia por **dos mecanismos**:
...
### Corrección en la inversión de MASW

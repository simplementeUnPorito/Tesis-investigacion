...
> donde $\phi$ es el **potencial escalar** (asociado a las [[P-waves|ondas de compresión P]]) y $\mathbf{\psi}$ es el **potencial vectorial** (asociado a las [[S-Waves|ondas de corte S]]). Sustituyendo en la ecuación de Navier de la elastodinámica, los potenciales satisfacen ecuaciones de onda desacopladas independientes:

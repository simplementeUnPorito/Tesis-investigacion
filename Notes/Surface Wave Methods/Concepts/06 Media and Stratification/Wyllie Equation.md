...
description: Ecuación de tiempo de tránsito promedio 1/VP = φ/Vf + (1-φ)/Vm que relaciona la velocidad VP con la porosidad — usada con la Ley de Archie para acoplar modelos ERT y [[MASW Method|MASW]] en [[Joint Inversion|inversión conjunta]] petrofísica
type: reference
---

...
description: Ecuación de tiempo de tránsito promedio 1/VP = φ/Vf + (1-φ)/Vm que relaciona la velocidad VP con la porosidad — usada con la Ley de Archie para acoplar modelos ERT y [[MASW Method|MASW]] en inversión conjunta petrofísica
type: reference
---
...
> Esta cadena permite la **inversión conjunta petrofísica**: los datos [[MASW Method|MASW]] ($V_S$, y $V_P$ por [[Seismic Refraction|refracción]]) y ERT ($\rho_t$) comparten el parámetro $\phi$ como variable latente. La limitación principal es que Wyllie subestima $V_P$ para rocas consolidadas y sobreestima para suelos poco compactados — en geotecnia superficial su uso es aproximado.
>

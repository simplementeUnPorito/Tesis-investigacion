...
| Onda | Naturaleza | [[Attenuation|Atenuación]] |
|------|-----------|-----------|
...
- El [[Shear Modulus|módulo de corte]] del esqueleto $G$ es el parámetro más relevante para las ondas S y Rayleigh — la saturación afecta principalmente a $V_P$, no a $V_S$.

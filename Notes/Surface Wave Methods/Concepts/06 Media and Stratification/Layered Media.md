...
**Normalmente dispersivo** (velocidad aumenta con profundidad): el modo fundamental domina y la [[Dispersion Curve|curva de dispersión]] tiene pendiente negativa (mayor Vr a baja frecuencia). Es el caso más frecuente en depósitos sedimentarios compactados.

**Inversamente dispersivo** (capa blanda debajo de capa rígida): los modos superiores pueden contribuir significativamente incluso a bajas frecuencias. La [[Dispersion Curve|curva de dispersión]] tiene pendiente positiva en parte del rango. La inversión asumiendo modo fundamental introduce errores severos.
...
- [[Dispersion Relation]] — la forma de la [[Dispersion Curve|curva de dispersión]] es determinada por el modelo de capas
...
| Xia, Miller & Park (1999), *Geophysics* 64(3) | Paper 002 — modelo de capas en inversión [[MASW Method|MASW]] |

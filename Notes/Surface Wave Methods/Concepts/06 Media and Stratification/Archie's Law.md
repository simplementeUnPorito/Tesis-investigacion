---
name: Archie's Law
description: Relación empírica ρ=a·ρw·φ⁻ᵐ·S⁻ⁿ entre la resistividad eléctrica del suelo saturado, la porosidad φ y la saturación S — usada para convertir datos ERT a propiedades petrofísicas en [[Joint Inversion|inversión conjunta]] con [[MASW Method|MASW]]
type: reference
---
...
| Foti et al. (2018), *Surface Wave Methods* | §8.6.1 — Archie en [[Joint Inversion|inversión conjunta]] [[MASW Method|MASW]]+ERT |

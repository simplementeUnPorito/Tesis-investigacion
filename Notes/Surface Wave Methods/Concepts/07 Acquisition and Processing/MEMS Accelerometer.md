...
description: Sensor de estado sólido que mide aceleración — alternativa al geófono en MASW; respuesta plana desde DC, digital, robusto; mayor ruido de piso en bajas frecuencias
type: reference
---
...
En el dominio de la frecuencia, la división por $i\omega$ o $(i\omega)^2$ es exacta. Para el análisis f-k del MASW, la fase de la señal no cambia con la integración → la curva de dispersión extraída es idéntica usando geófonos o MEMS.

## Aplicaciones en métodos de ondas superficiales

- **MASW activo (5–100 Hz)**: los MEMS son equivalentes a los geófonos de 4.5–14 Hz. El ruido de piso elevado a <1 Hz no afecta el análisis.

...
3. Identificar el **borde mínimo de velocidad** en el espectro f-k: los puntos de mínimo número de onda para cada frecuencia corresponden a la [[Phase Velocity|velocidad de fase]] de Rayleigh.

...
1. **Validación**: Los perfiles $V_S(z)$ obtenidos por cross-hole o down-hole son la referencia de oro para evaluar la precisión de los perfiles derivados por inversión de la [[Dispersion Curve|curva de dispersión]].

2. **Parámetros a priori**: El [[Non-uniqueness|problema de no-unicidad]] de la inversión requiere parámetros fijos. El perfil $V_P(z)$ (o el [[Poisson Ratio|coeficiente de Poisson]]) obtenido por refracción sísmica o down-hole se usa como entrada fija en la inversión de la [[Dispersion Curve|curva de dispersión]] de [[Rayleigh Waves]].

> [!EXAMPLE] Evidencia empírica: Xia et al. (2002) — [[MASW Method|MASW]] validado contra cross-hole y down-hole
> **Paper 009 (Xia et al. 2002)** valida explícitamente los perfiles $V_S(z)$ de [[MASW Method|MASW]] contra 14 ensayos de borehole independientes (cross-hole y down-hole) en Kansas. El error RMS entre $V_S$ [[MASW Method|MASW]] y borehole es < 15% para todos los sitios, con errores individuales < 5% en sitios simples. El trabajo establece que el [[MASW Method|MASW]] es competitivo con los métodos invasivos para caracterización geotécnica estándar (VS,30), reduciendo el costo a menos de 1/10 del borehole equivalente.
>
...
| Xia et al. (2002), *J. Environ. Eng. Geophys.* | Paper 009 — [[MASW Method|MASW]] vs. borehole |

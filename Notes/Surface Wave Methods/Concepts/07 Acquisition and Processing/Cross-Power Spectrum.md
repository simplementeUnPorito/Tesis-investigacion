...
description: Espectro cruzado entre dos señales sísmicas — base del método [[SASW Method|SASW]] para extraer la fase (y por tanto la [[Phase Velocity|velocidad de fase]]) entre pares de receptores
type: reference
---
...
La **[[Phase Velocity|velocidad de fase]]** ([[SASW Method|SASW]]):
...
> [!EXAMPLE] Evidencia empírica: Nazarian & Stokoe (1984) — espectro cruzado como base del [[SASW Method|SASW]]
> **Paper 003 (Nazarian & Stokoe 1984)** introduce el espectro cruzado entre pares de receptores como la herramienta central para extraer la [[Phase Velocity|velocidad de fase]] de ondas de Rayleigh en el [[SASW Method|método SASW]]. Los autores demuestran que la fase de $G_{12}(f)$, una vez corregida por phase unwrapping, es proporcional al [[Wavenumber|número de onda]] del modo fundamental de Rayleigh con alta precisión en el rango de frecuencias con alta coherencia ($\gamma^2 > 0.9$). El trabajo establece el uso del CPS como estimador eficiente de la [[Phase Velocity|velocidad de fase]] para dos receptores, sin necesidad de un arreglo multicanal completo — clave en la época (1984) cuando los sismógrafos de muchos canales no estaban disponibles comercialmente.
>
...
|--------|-----------------|
| Foti et al. (2018), *Surface Wave Methods* | Cap. 4, §4.2 — CPS en procesamiento [[SASW Method|SASW]]/[[MASW Method|MASW]] |
| Nazarian & Stokoe (1984), *8th WCEE* | Paper 003 — espectro cruzado como base del [[SASW Method|SASW]] |

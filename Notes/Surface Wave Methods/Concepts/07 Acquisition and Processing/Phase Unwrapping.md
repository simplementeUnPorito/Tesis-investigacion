...
description: Proceso de corrección de saltos de 2π en la fase del espectro cruzado — limitación principal del método SASW con dos receptores
type: reference
---
...
## Ventaja del MASW sobre el SASW

En el análisis f-k del [[MASW Method|MASW]], la velocidad de fase se identifica como la posición del **máximo espectral** en el espectrograma $|U(\omega, k)|$. Este procedimiento no requiere unwrapping porque:
...
|--------|-----------------|
| Foti et al. (2018), *Surface Wave Methods* | Cap. 4, §4.2 — phase unwrapping en SASW |
| Nazarian & Stokoe (1984), *8th WCEE* | Paper 003 — SASW con unwrapping manual |

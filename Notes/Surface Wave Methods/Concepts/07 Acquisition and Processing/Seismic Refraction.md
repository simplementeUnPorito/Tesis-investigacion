...
description: Método sísmico no invasivo que mide los tiempos de llegada de primeras ondas P refractadas — complementario a [[MASW Method|MASW]] para obtener VP y detectar la tabla de agua
type: reference
---

...
description: Función de coherencia γ²(f) entre dos señales sísmicas — indicador de SNR del espectro cruzado; criterio de calidad en SASW para seleccionar puntos confiables de la curva de dispersión
type: reference
---
...
|---|---|---|
| $\gamma^2 \approx 1$ | Alta SNR, señal determinista | Retener punto de la curva de dispersión |
...
## Relación con la incertidumbre de la curva de dispersión

La coherencia está inversamente relacionada con la incertidumbre de la velocidad de fase estimada mediante el espectro cruzado (método SASW/[[MOPA]]). Cuanto menor la coherencia, mayor la dispersión estadística de la fase entre disparos y mayor la incertidumbre $\sigma_{c_R}(f)$.

> [!EXAMPLE] Evidencia empírica: Nazarian & Stokoe (1984) — coherencia como criterio de calidad en SASW
> **Paper 003 (Nazarian & Stokoe 1984)** establece el uso de la función de coherencia como criterio estándar para seleccionar las frecuencias confiables de la curva de dispersión SASW. Los autores muestran que en el rango de frecuencias donde $\gamma^2 > 0.9$, la fase del [[Cross-Power Spectrum|espectro cruzado]] es estable entre disparos repetidos y produce velocidades de fase reproducibles. En contraste, en las frecuencias fuera de ese rango (típicamente las bajas frecuencias con bajo SNR para el sledgehammer usado, y las altas frecuencias con aliasing), la coherencia cae y la fase es inestable — esas frecuencias se excluyen. El procedimiento de filtrado por coherencia se convirtió en el estándar de facto para el control de calidad de datos SASW y se extendió posteriormente al [[MASW Method|MASW]] (donde la coherencia se estima entre pares de receptores del arreglo multicanal).
>
...
|--------|-----------------|
| Foti et al. (2018), *Surface Wave Methods* | Cap. 4, §4.2 — coherencia en SASW/MASW |

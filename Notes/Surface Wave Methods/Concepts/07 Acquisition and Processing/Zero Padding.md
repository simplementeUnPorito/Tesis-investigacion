---
name: Zero Padding
description: Técnica de procesamiento que añade ceros al final de una señal antes de la FFT para aumentar la resolución frecuencial aparente del espectro — usada en MASW para interpolar el panel f-k y estimar con mayor precisión el pico de velocidad de fase a cada frecuencia
type: reference
---
...
## Regla práctica para MASW

Para el análisis $f$-$k$ de un arreglo de $N$ geófonos:
...
|--------|-----------------|
| Foti et al. (2018), *Surface Wave Methods* | §3.4.1 — análisis espectral con zero padding en MASW |

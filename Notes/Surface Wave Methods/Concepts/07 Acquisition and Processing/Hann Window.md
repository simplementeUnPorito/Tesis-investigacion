---
name: Hann Window
description: Función de ventana temporal que reduce la fuga espectral en el análisis de Fourier de señales sísmicas — estándar en procesamiento MASW para espectrogramas f-k
type: reference
---
...
| Park, Miller & Xia (1999), *Geophysics* 64(3) | Paper 001 — ventana Hann en espectrograma MASW |

...
|---|---|---|
| Espaciado [[Geophone|geófono]] $\Delta x$ | $\lambda_{\min}$ ([[Aliasing|aliasing]] espacial) | $\lambda_{\min} = 2\Delta x$ |
...
El teorema de muestreo espacial impone que para medir una onda de longitud de onda $\lambda$ con un arreglo de [[Geophone|geófono]] de espaciado $\Delta x$, se necesitan al menos **dos muestras por longitud de onda**:

---
name: Dirac Comb
description: Tren de deltas de Dirac III(t) = Σδ(t-nΔt) que modela el muestreo temporal discreto en adquisición sísmica — genera periodicidad espectral y [[Aliasing|aliasing]] cuando la señal contiene frecuencias por encima de Nyquist
type: reference
---
...
|--------|-----------------|
| Foti et al. (2018), *Surface Wave Methods* | §3.3.3 — muestreo y [[Aliasing|aliasing]] en [[MASW Method|MASW]] |

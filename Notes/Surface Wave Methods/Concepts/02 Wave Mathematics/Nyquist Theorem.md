...
description: Condición de muestreo que establece que la frecuencia de muestreo debe ser al menos el doble de la frecuencia máxima de la señal para evitar aliasing temporal en [[MASW Method|MASW]]
type: reference
---
...
La longitud de onda mínima libre de aliasing es $\lambda_{min} = 2\Delta x$. La condición anti-aliasing para la [[Phase Velocity|velocidad de fase]] es:
...
> [!EXAMPLE] Evidencia empírica: Park et al. (1999) — diseño anti-aliasing del arreglo [[MASW Method|MASW]]

---
name: Fourier Series
description: Representación de señales periódicas como suma de componentes armónicas — base del análisis espectral en procesamiento sísmico y el fundamento de la transformada de Fourier discreta usada en MASW
type: reference
---

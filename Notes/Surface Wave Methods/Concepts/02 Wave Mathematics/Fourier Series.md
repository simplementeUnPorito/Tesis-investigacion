...
## Par de Fourier relevante para [[Surface Waves|ondas superficiales]]
...
|--------|-----------------|
| Foti et al. (2018), *Surface Wave Methods* | §3.3.1 — análisis espectral de [[Surface Waves|ondas superficiales]] |

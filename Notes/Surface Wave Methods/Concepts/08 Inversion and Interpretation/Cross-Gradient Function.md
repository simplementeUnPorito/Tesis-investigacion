...
description: Función de acoplamiento estructural en [[Joint Inversion|inversión conjunta]] multi-física que penaliza cuando los gradientes de dos modelos (VS y VP, o sísmico y eléctrico) apuntan en direcciones diferentes — impone co-localización de interfaces sin atar los valores
type: reference
---
...
|--------|-----------------|
| Foti et al. (2018), *Surface Wave Methods* | §8.6.2 — [[Joint Inversion|inversión conjunta]] multi-física con cross-gradients |

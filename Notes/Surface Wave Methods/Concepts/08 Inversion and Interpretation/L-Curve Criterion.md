...
description: Criterio gráfico para seleccionar el parámetro de [[Regularization|regularización]] óptimo λ en inversión de Tikhonov — basado en la curva log||Jm-d|| vs log||Lm|| cuyo punto de máxima curvatura ("esquina de la L") balancea ajuste y suavidad
type: reference
---

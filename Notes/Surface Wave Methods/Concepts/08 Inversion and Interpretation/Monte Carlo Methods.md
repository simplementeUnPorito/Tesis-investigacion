...
3. Obtener una **caracterización probabilística** del perfil de Vs: bandas de confianza, percentiles, distribución de parámetros derivados como [[Vs30|Vs,30]].
...
- **[[Vs30|Vs,30]]**: varía entre ~480 y 505 m/s para todos los perfiles aceptables (Fig. 7.22, p. 374) — variación estrecha y gestionable para aplicaciones normativas.

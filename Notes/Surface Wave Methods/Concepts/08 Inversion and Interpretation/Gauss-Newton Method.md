...
description: Algoritmo de inversión no lineal iterativo que aproxima el Hessiano como JᵀJ — base del método de Levenberg-Marquardt para inversión de curvas de dispersión MASW con convergencia cuadrática
type: reference
---
...
| Xia et al. (1999), *Geophysics* 64(3), 691–700 | Implementación Gauss-Newton para MASW |
